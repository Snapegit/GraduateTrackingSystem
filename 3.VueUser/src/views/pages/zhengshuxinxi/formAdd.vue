...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"20px","background":"#fff","width":"64%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="8">
					<el-form-item label="申请编号" prop="shenqingbianhao">
						<el-input class="list_inp" v-model="form.shenqingbianhao" placeholder="请输入申请编号" readonly></el-input>
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="证书名称" prop="zhengshumingcheng">
						<el-input class="list_inp" v-model="form.zhengshumingcheng" placeholder="证书名称"
							 type="text" 							:readonly="!isAdd||disabledForm.zhengshumingcheng?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="用途" prop="yongtu">
						<el-input class="list_inp" v-model="form.yongtu" placeholder="用途"
							 type="text" 							:readonly="!isAdd||disabledForm.yongtu?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="8">
					<el-form-item label="证书状态" prop="zhengshuzhuangtai">
						<el-select
							class="list_sel"
							:disabled="!isAdd||disabledForm.zhengshuzhuangtai?true:false"
							v-model="form.zhengshuzhuangtai" 
							placeholder="请选择证书状态"
							style="width:100%;"
							>
							<el-option v-for="(item,index) in zhengshuzhuangtaiLists" :label="item"
								:value="item"
								>
							</el-option>
						</el-select>
...
<script setup>
	...
	//证书状态列表
	const zhengshuzhuangtaiLists = ref([])
	//methods
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			// getInfo()
			for(let x in row){
				if(x=='shenqingbianhao'){
					form.value.shenqingbianhao = row[x];
					disabledForm.value.shenqingbianhao = true;
					continue;
				}
				if(x=='zhengshumingcheng'){
					form.value.zhengshumingcheng = row[x];
					disabledForm.value.zhengshumingcheng = true;
					continue;
				}
				if(x=='zhengshutupian'){
				...
				if(x=='zhengshuzhuangtai'){
					form.value.zhengshuzhuangtai = row[x];
					disabledForm.value.zhengshuzhuangtai = true;
					continue;
				}
				if(x=='zhanghao'){
		...
		zhengshuzhuangtaiLists.value = "待发放,已发放".split(',')
	}
	//初始化
	//取消
	const backClick = () => {
