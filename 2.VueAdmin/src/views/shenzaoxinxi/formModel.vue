	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="24">
						<el-form-item label="深造学校" prop="shenzaoxuexiao">
							<el-input class="list_inp" v-model="form.shenzaoxuexiao" placeholder="深造学校"
								 type="text" 								:readonly="!isAdd||disabledForm.shenzaoxuexiao?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="深造专业" prop="shenzaozhuanye">
							<el-input class="list_inp" v-model="form.shenzaozhuanye" placeholder="深造专业"
								 type="text" 								:readonly="!isAdd||disabledForm.shenzaozhuanye?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="深造时间" prop="shenzaoshijian">
							<el-input class="list_inp" v-model="form.shenzaoshijian" placeholder="深造时间"
								 type="text" 								:readonly="!isAdd||disabledForm.shenzaoshijian?true:false" />
						</el-form-item>
					</el-col>

					<el-col :span="24">
						<el-form-item label="深造状态" prop="shenzaozhuangtai">
							<el-select
								class="list_sel"
								:disabled="!isAdd||disabledForm.shenzaozhuangtai?true:false"
								v-model="form.shenzaozhuangtai" 
								placeholder="请选择深造状态"
								>
								<el-option v-for="(item,index) in shenzaozhuangtaiLists" :label="item"
									:value="item"
									>
								</el-option>
							</el-select>
...
<script setup>
	...
	const disabledForm = ref({
		shenzaoxuexiao : false,
		shenzaozhuanye : false,
		shenzaoshijian : false,
		shenzaozhuangtai : false,
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='shenzaoxuexiao'){
					form.value.shenzaoxuexiao = row[x];
					disabledForm.value.shenzaoxuexiao = true;
					continue;
				}
				if(x=='shenzaozhuanye'){
					form.value.shenzaozhuanye = row[x];
					disabledForm.value.shenzaozhuanye = true;
					continue;
				}
				if(x=='shenzaoshijian'){
					form.value.shenzaoshijian = row[x];
					disabledForm.value.shenzaoshijian = true;
					continue;
				}
				if(x=='shenzaozhuangtai'){
					form.value.shenzaozhuangtai = row[x];
					disabledForm.value.shenzaozhuangtai = true;
					continue;
				}
				if(x=='tianbaoshijian'){
